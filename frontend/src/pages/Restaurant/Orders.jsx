...
export default function RestaurantOrders() {
      ...
      case 'refunded':
        return (
          <span className="px-3 py-1 bg-purple-100 text-purple-700 rounded-full text-xs font-bold uppercase">
            <RollbackOutlined className="mr-1" /> Refunded
          </span>
        );
  ...
  const tabs = [
    ...
    { key: 'refunded', label: 'Refunded', icon: <RollbackOutlined /> },
  ];
                  ...
                  <td className="p-4 text-right">
                    <div className="flex flex-col gap-2 items-end">
                      ...
                      {order.status === 'refunded' && (
                        <div className="text-[11px] text-purple-600 font-bold bg-purple-50 px-3 py-1 rounded-full border border-purple-100">
                          Refunded
                        </div>
                      )}
                    </div>
